...
import com.xxx.c1_factory_method_pattern.before.AwardReq;
import com.xxx.c1_factory_method_pattern.before.AwardRes;
import com.xxx.c1_factory_method_pattern.before.PrizeController;
...
public class ApiTest_Before {
    ...
    private Logger logger = LoggerFactory.getLogger(ApiTest_Before.class);
